...
if("TRUE" STREQUAL "TRUE")
  set(cvg_sim_gazebo_SOURCE_PREFIX /home/g01b/3dslam/src/ardrone_simulator_gazebo7/cvg_sim_gazebo)
  set(cvg_sim_gazebo_DEVEL_PREFIX /home/g01b/3dslam/devel)
  ...
  set(cvg_sim_gazebo_INSTALL_PREFIX /home/g01b/3dslam/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cvg_sim_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/g01b/3dslam/src/ardrone_simulator_gazebo7/cvg_sim_gazebo/${idir}'.  ${_report}")
    endif()
