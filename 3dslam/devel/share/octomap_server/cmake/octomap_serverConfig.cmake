...
if("TRUE" STREQUAL "TRUE")
  set(octomap_server_SOURCE_PREFIX /home/g01b/3dslam/src/octomap_mapping/octomap_server)
  set(octomap_server_DEVEL_PREFIX /home/g01b/3dslam/devel)
  ...
  set(octomap_server_INSTALL_PREFIX /home/g01b/3dslam/install)
...
if(NOT "/home/g01b/3dslam/devel/include;/home/g01b/3dslam/src/octomap_mapping/octomap_server/include;/opt/ros/kinetic/include " STREQUAL " ")
  set(octomap_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/g01b/3dslam/devel/include;/home/g01b/3dslam/src/octomap_mapping/octomap_server/include;/opt/ros/kinetic/include")
  ...
  elseif(NOT "http://www.ros.org/wiki/octomap_server " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Wolfgang Merkt <w.merkt+oss@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'octomap_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/g01b/3dslam/src/octomap_mapping/octomap_server/${idir}'.  ${_report}")
    endif()
    _list_append_unique(octomap_server_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "octomap_server;/opt/ros/kinetic/lib/liboctomap.so;/opt/ros/kinetic/lib/liboctomath.so")
