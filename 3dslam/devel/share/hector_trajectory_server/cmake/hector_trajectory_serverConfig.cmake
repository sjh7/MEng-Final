...
if("TRUE" STREQUAL "TRUE")
  set(hector_trajectory_server_SOURCE_PREFIX /home/g01b/3dslam/src/hector_slam/hector_trajectory_server)
  set(hector_trajectory_server_DEVEL_PREFIX /home/g01b/3dslam/devel)
  ...
  set(hector_trajectory_server_INSTALL_PREFIX /home/g01b/3dslam/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_trajectory_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/g01b/3dslam/src/hector_slam/hector_trajectory_server/${idir}'.  ${_report}")
    endif()
